...
class TaskBlockPolicy
{
    ...
    * @return mixed
    */
   public function edit(Teacher $teacher, TaskBlock $textBlock)
   {
       return true;
   }
    ...
    * @return mixed
    */
   public function update(Teacher $teacher, TaskBlock $textBlock)
   {
       return true;
   }
    ...
    * @return mixed
    */
   public function destroy(Teacher $teacher, TaskBlock $textBlock)
   {
       return true;
   }
